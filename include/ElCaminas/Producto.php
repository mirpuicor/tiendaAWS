...
class Producto
{
    ...
    public function getHtml(){
      ...
      $str .= "<a href='./carro.php?action=add&redirect=".$this->getUrl()."&id=" . $this->id . "&cantidad=1' class='btn btn-danger' style='position:absolute; bottom:4px; right:4px'>Comprar</a>";
      /*&redirect=".."*/
      return $str;
    ...
    public function getThumbnailHtml(){
      ...
      $str = "<div class='col-sm-4 col-lg-4 col-md-4'>";
        $str .= "<div class='thumbnail' style='position:relative'>";
          ...
          $str .= "<div class='caption'>";
            $str .= "<h4><a href='" .  $this->url . "'>". $this->nombre . " </a><a class='open-modal' href='" . $this->url . "'><span class='fa fa-external-link' style='color:#233936'></span></a></h4>";
            $str .= "<p>". $this->descripcion . "</p>";
          $str .= "</div>";
          $str .= "<h4 class='pull-right'>" . $this->getHtmlPrecio() . "</h4>";
          $str .= "<a href='./carro.php?action=add&redirect=".$this->getUrl()."&id=" . $this->id . "&cantidad=1' class='btn btn-danger'>Comprar</a>";
        $str .= "</div>";
      $str .= "</div>";
      return $str;
